...
Open questions expose details absent from the source. Security, lifecycle and consistency cautions in the module prose identify matters requiring a decision before unsafe assumptions; they do not claim a complete security design was supplied. Implemented-main notes, later-decision OQs ([OQ-011](../open-questions.md#oq-011) through [OQ-016](../open-questions.md#oq-016)) and partial lands for [OQ-005](../open-questions.md#oq-005), [OQ-006](../open-questions.md#oq-006), [OQ-007](../open-questions.md#oq-007) and [OQ-016](../open-questions.md#oq-016) v1 chrome live in the repository specifications, not in this archive. See [upstream links](upstream.md) for original references and the small set of additional official maintenance references.
