...
[WF-001](#wf-001) and [WF-002](#wf-002) stay unimplemented until Builder exists. v1 chrome is locked in [ADR-0003](../decisions/ADR-0003-builder-v1-chrome.md); that is not a Builder-shipped claim and does not change [WF-001](#wf-001) behaviour. Do not treat the Agent-run panel as Builder.
