...
[OQ-004](../open-questions.md#oq-004) run identities, event order and exactly-once; [OQ-006](../open-questions.md#oq-006) retrieval through LangChain components (decision pending research) and cross-surface knowledge; [OQ-009](../open-questions.md#oq-009) optional middleware; [OQ-011](../open-questions.md#oq-011) Approvals inbox; [OQ-015](../open-questions.md#oq-015) workflow import/export; [OQ-016](../open-questions.md#oq-016) Builder surface. Profile `agent.system_prompt` is preferred over a Chat surface prompt (composed, not silently replaced).
