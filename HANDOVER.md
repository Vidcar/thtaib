...
Updated 2026-09-24. The Deep Agents 0.7.18 simplification is merged in [PR #148](https://github.com/Vidcar/thtaib/pull/148). This follow-up fixes Chat showing “Apply the changed model settings before sending a message” after a named model variant was applied, including in a new chat. Work is on `codex/fix-chat-model-variant-apply` pending Git delivery.
...
Next: review the focused diff, commit, push, open and merge the PR, then confirm the local checkout is current. Shell commands must use RTK.
