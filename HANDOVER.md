...
Updated 2026-09-25. Selected installed Hugging Face model-card work is implemented and running locally. Delivery branch: `codex/selected-hf-model-card`. The completed OpenSpec change is archived at `openspec/changes/archive/2026-09-25-selected-hf-model-card/`, and the updated Models contract is in `openspec/specs/models/spec.md`.
...
Next: deliver and merge the reviewed PR, then confirm the clean main checkout. Prior completed setup simplification: [PR #159](https://github.com/Vidcar/thtaib/pull/159).
