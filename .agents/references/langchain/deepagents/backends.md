...
* `rt.context`—User-supplied context passed via LangGraph's [context schema](https://docs.langchain.com/oss/python/langgraph/graph-api#runtime-context) (for example, `user_id`)
