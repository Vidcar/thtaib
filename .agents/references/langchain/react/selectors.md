...
| `useAudio` / `useImages` / `useVideo` / `useFiles`                      | `AudioMedia[]` / `ImageMedia[]` / `VideoMedia[]` / `FileMedia[]` | Assembled multimodal streams. See [Multimodal](https://github.com/langchain-ai/langgraphjs/blob/ec67d5d70dc26341e92a0962d9d2f4018c310b39/libs/sdk-react/docs/multimodal.md).           |
...
This is the v1 replacement for the old `onLangChainEvent` / `onCustomEvent` callbacks (see [migration](https://github.com/langchain-ai/langgraphjs/blob/ec67d5d70dc26341e92a0962d9d2f4018c310b39/libs/sdk-react/docs/v1-migration.md)): keep side effects out of render, scoped to the channels you actually care about.
...
- [Subagents & subgraphs](https://github.com/langchain-ai/langgraphjs/blob/ec67d5d70dc26341e92a0962d9d2f4018c310b39/libs/sdk-react/docs/subagents.md)
- [Multimodal media](https://github.com/langchain-ai/langgraphjs/blob/ec67d5d70dc26341e92a0962d9d2f4018c310b39/libs/sdk-react/docs/multimodal.md)
