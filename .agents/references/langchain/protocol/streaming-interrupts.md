...
- [Messages & tokens](https://github.com/langchain-ai/langgraphjs/blob/ec67d5d70dc26341e92a0962d9d2f4018c310b39/libs/sdk/docs/streaming-messages.md) — the `thread.messages`
  projection that pairs naturally with interrupts.
- Framework-specific higher-level flows (headless tools, automatic
  interrupt routing):
  - [`@langchain/react` interrupts](../react/interrupts.md)
  - [`@langchain/svelte` interrupts](https://github.com/langchain-ai/langgraphjs/blob/ec67d5d70dc26341e92a0962d9d2f4018c310b39/libs/sdk-svelte/docs/interrupts.md)
