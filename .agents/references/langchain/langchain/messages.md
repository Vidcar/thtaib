...
* <Icon icon="tool" size={16} /> [Tool message](#tool-message) - Represents the outputs of [tool calls](https://docs.langchain.com/oss/python/langchain/models#tool-calling)
...
Other structured data, such as reasoning or citations, can also appear in message [content](./messages.md#message-content).
