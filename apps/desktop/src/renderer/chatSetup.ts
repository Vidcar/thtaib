...
export const chatSetupFields = ["deployment_id", "profile_id", "inherit_deployment_settings", "embedding_deployment_id", "presented_tools", "per_request_overrides", "memory_version_refs", "skill_version_refs", "protected_instruction_version_refs", "knowledge_version_refs", "connection_ids", "instructions"] as const;
