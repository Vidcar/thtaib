...
import "../../src/renderer/chatPolish.css";
import "../../src/renderer/surfacePolish.css";
const root = createRoot(document.getElementById("root")!);
let messages: Array<AIMessage | HumanMessage> = [];
const paint = (live = false) => root.render(<div className="chat-main" style={{ width: 900 }}><div className="transcript" tabIndex={0} style={{ height: 600, flex: "none" }}><AgentMessageFeed messages={messages} live={live} /></div></div>);
...
Object.assign(window, { fixture: {
  ...
  async turn(count = 40) {
    ...
    paint(false); await frame(); samples.push(geometry()); return samples;
  },
