...
- [ ] 1.3 Verify existing SSE snapshot/reconnect and terminal hydration in `event_stream.py`, desktop `sse.ts` and their regression checks; complete missing incremental answer/reasoning/tool presentation and reconciliation, and expose observed planning/context.
...
- [ ] 2.4 Test reconnect/gaps/late events/terminal hydration with no duplicated or cross-conversation content; retain partial text and actual tool results.
