...
3. **Streaming** — stream run events instead of polling ([DEV-005](../specs/deviations.md#dev-005)); fix the profile `system_prompt` override. Project-less Chat ([DEV-003](../specs/deviations.md#dev-003)) and harness scratch isolation ([DEV-004](../specs/deviations.md#dev-004)) landed in [PR #85](https://github.com/Vidcar/thtaib/pull/85); llama-server process logs landed in [PR #86](https://github.com/Vidcar/thtaib/pull/86).
