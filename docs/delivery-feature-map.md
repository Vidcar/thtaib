...
2. **Effective setup (implementation)** — after continuity. Selected profile and knowledge must change the request, not labels only ([ARCH-003](../specs/architecture.md#arch-003); [#37](https://github.com/Vidcar/thtaib/issues/37) area 2). Sibling docs: [#53](https://github.com/Vidcar/thtaib/issues/53). Implementation: [#57](https://github.com/Vidcar/thtaib/issues/57) (UAT remains David-PC).
...
- **Issues:** closed [#12](https://github.com/Vidcar/thtaib/issues/12), [#22](https://github.com/Vidcar/thtaib/issues/22), [#27](https://github.com/Vidcar/thtaib/issues/27), [#40](https://github.com/Vidcar/thtaib/issues/40), [#41](https://github.com/Vidcar/thtaib/issues/41), [#42](https://github.com/Vidcar/thtaib/issues/42). High-level continuity / UX spec [#52](https://github.com/Vidcar/thtaib/issues/52). Effective-setup contract [#53](https://github.com/Vidcar/thtaib/issues/53). Open tracker [#37](https://github.com/Vidcar/thtaib/issues/37) areas 1–2. Continuity implementation is [#56](https://github.com/Vidcar/thtaib/issues/56). Effective-setup implementation is [#57](https://github.com/Vidcar/thtaib/issues/57) (UAT David-PC). Chat deploy-health honesty is [#78](https://github.com/Vidcar/thtaib/issues/78) (leftover from #56 / PR #69; does not reopen #56 AC). Debug-quality Chat is not polish.
