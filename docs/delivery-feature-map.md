...
5. **Retrieval v1** — research recorded; specified as [STATE-006](../specs/modules/state-recovery.md#state-006) (`planned`). Implement Deep Agents retrieve-and-offload over a derived `InMemoryVectorStore`; do not write a second knowledge store ([OQ-006](../specs/open-questions.md#oq-006)).
