...
| Effective setup contract | Agent Chat (also Lab / Builder consumers) | [#37](https://github.com/Vidcar/thtaib/issues/37) area 2: selected profile and knowledge version must affect the actual request, not labels only. [REG-005](../specs/modules/registry.md#reg-005) is `planned`. |
