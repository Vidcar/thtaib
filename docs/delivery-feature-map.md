...
3. **Project storage hardening and streaming** — landed in PRs #85 and #87: harness scratch stays out of the project ([DEV-004](../specs/deviations.md#dev-004)); Chat works without a project folder ([DEV-003](../specs/deviations.md#dev-003)); run events stream over SSE instead of 750 ms polling ([DEV-005](../specs/deviations.md#dev-005)). Remaining: fix the profile `system_prompt` override; capture `llama-server` logs instead of discarding them.
